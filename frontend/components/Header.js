        ...
        >
          <div class="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
            ...
            <div className="relative">
              ...
              >
                <span className="tr04">หมวดหมู่</span>
                <svg
                  className={
                    flyer === true
                  ...
                  <div className="relative grid gap-6 bg-black px-2 py-6 sm:gap-8 ">
                    ...
                    >
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          หนังสือเกี่ยวกับปรัชญาและการใช้ชีวิต
                        </p>
                      </div>
                    </a>
                    <a
                    ...
                    >
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          ความรู้ทั่วไปที่เหมาะกับคนทุกวัย
                        </p>
                      </div>
                    </a>
                    <a
                    ...
                    >
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          รวบรวมหนังสือภาษาต่างๆจากทั่วทุกมุมโลก
                        </p>
                      </div>
                    </a>
                    <a
